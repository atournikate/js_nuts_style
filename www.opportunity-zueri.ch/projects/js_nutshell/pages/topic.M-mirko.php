...
function run() {
    ...
    document.getElementbyId('output').innerHTML = output;
                    ...
                    <div class="col-6-md col-12-sm output">
                        ...
                        <button class="btn" name="run2" onclick="runScript(1, this);">Run Script</button>
                        <button class="btn" name="reset2" onclick="reset(1, this);">Reset Script</button>
                    </div>
                </div>
...
function run() {
    ...
    document.getElementbyId('output').innerHTML = output;
                    ...
                    <div class="col-6-md col-12-sm output">
                        ...
                        <button class="btn" name="run2" onclick="runScript(2, this);">Run Script</button>
                        <button class="btn" name="reset2" onclick="reset(2, this);">Reset Script</button>
                    </div>
                </div>
...
function run() {  
    document.getElementbyId('output').innerHTML = output;
                    ...
                    <div class="col-6-md col-12-sm output">
                        ...
                        <button class="btn" name="run1" onclick="runScript(3, this);">Run Script</button>
                        <button class="btn" name="reset1" onclick="reset(3, this);">Reset Script</button>
                    </div>
                </div>
...
function run() {  
    ...
    document.getElementbyId('output').innerHTML = output;
                    ...
                    <div class="col-6-md col-12-sm output">
                        ...
                        <button class="btn" name="run1" onclick="runScript(4, this);">Run Script</button>
                        <button class="btn" name="reset1" onclick="reset(4, this);">Reset Script</button>
                    </div>
                </div>
                ...
                <div class="codeArea flex-container codeExample">
                    ...
                    <p>
                        Creating a Dataobject and using it to output the values:<!-- ARTICLE -->
                    </p>
                    <div class="col-6-md col-12-sm code">
                        <h4>Code:</h4>
                        <p>
    ...
    function run() {
        try {
            ...
            document.getElementbyId('output').innerHTML = output;
                        ...
                        <button class="btn" name="run1" onclick="runScript(5, this);">Run Script</button>
                        <button class="btn" name="reset1" onclick="reset(5, this);">Reset Script</button>
                    </div>
                </div>
...
document.getElementbyId('output').innerHTML = text;
                ...
                <div class="col-6-md col-12-sm output">
                    ...
                    <button class="btn" name="run1" onclick="runScript(6, this);">Run Script</button>
                    <button class="btn" name="reset1" onclick="reset(6, this);">Reset Script</button>
                </div>
            </div>
